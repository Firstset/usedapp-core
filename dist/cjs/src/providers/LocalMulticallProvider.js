...
function LocalMulticallProvider(_a) {
    ...
    var multicallAddresses = (0, config_1.useConfig)().multicallAddresses;
    var _b = (0, hooks_1.useEthers)(), library = _b.library, chainId = _b.chainId;
    var _c = (0, react_1.useState)(LocalMulticallState.Unknown), localMulticallState = _c[0], setLocalMulticallState = _c[1];
    var _d = (0, react_1.useState)(), multicallBlockNumber = _d[0], setMulticallBlockNumber = _d[1];
            ...
            var deployMulticall = function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _d.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, (0, contract_1.deployContract)(MultiCall_json_1["default"], signer_1)];
                        case 1:
