...
function useChainCalls(calls) {
    var _a = (0, react_1.useContext)(context_1.ChainStateContext), dispatchCalls = _a.dispatchCalls, value = _a.value;
    ...
    return (0, react_1.useMemo)(function () { return calls.map(function (call) { var _a, _b; return call && ((_b = (_a = value === null || value === void 0 ? void 0 : value.state) === null || _a === void 0 ? void 0 : _a[call.address]) === null || _b === void 0 ? void 0 : _b[call.data]); }); }, [
